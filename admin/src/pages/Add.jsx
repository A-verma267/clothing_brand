...
const Add = ({ token }) => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      toast.success("Adding Product Wait  ")
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3' action="">
      ...
      <div className='w-full'>
        ...
        <input onChange={(e) => setDesc(e.target.value)} value={desc} className="w-full max-w-[500px] px-3 py-2" type="text" placeholder='Write description' required />
      </div>
